...
const exactDishes: Record<string, { name: string, price?: number, variants?: MenuVariant[] }[]> = {
  "Burger": [
    ...
    { name: "Veg Aloo Tikki Extra Mayo Burger", price: 80 },
    { name: "Veg Aloo Tikki Schezwan Burger", price: 80 },
    { name: "Veg Aloo Tikki Cheese Burger", price: 90 },
    { name: "Peri Peri Cheese Burger", price: 100 },
    { name: "Paneer Tikki Burger", price: 100 },
    { name: "Veg Aloo Tikki Schezwan Cheese Burger", price: 100 },
    { name: "Paneer Tikki Cheese Burger", price: 120 },
  ],
  "Pizza": [
    { name: "Corn Cheese Pizza", variants: [{ name: "6 inch", price: 140 }, { name: "8 inch", price: 170 }] },
    { name: "Veg Exotic Cheese Pizza", variants: [{ name: "6 inch", price: 140 }, { name: "8 inch", price: 170 }] },
    { name: "Veg Tandoori Cheese Pizza", variants: [{ name: "6 inch", price: 140 }, { name: "8 inch", price: 170 }] },
    { name: "Onion Capcicum Pizza", variants: [{ name: "6 inch", price: 140 }, { name: "8 inch", price: 170 }] },
    { name: "Onion Cheese Pizza", variants: [{ name: "6 inch", price: 140 }, { name: "8 inch", price: 170 }] },
    { name: "Capcicum Cheese Pizza", variants: [{ name: "6 inch", price: 140 }, { name: "8 inch", price: 170 }] },

    
    { name: "Plain Cheese Pizza", variants: [{ name: "6 inch", price: 140 }, { name: "8 inch", price: 170 }] },
    { name: "Paneer Cheese Pizza", variants: [{ name: "6 inch", price: 150 }, { name: "8 inch", price: 180 }] },

    { name: "Paneer Capcicum Cheese Pizza", variants: [{ name: "6 inch", price: 150 }, { name: "8 inch", price: 180 }] },

    { name: "Veg B.B.Q. Cheese Pizza", variants: [{ name: "6 inch", price: 150 }, { name: "8 inch", price: 180 }] },
    { name: "Super Cheese Bust Pizza", variants: [{ name: "6 inch", price: 180 }, { name: "8 inch", price: 210 }] },

  ],
  "Sandwich": [
    { name: "Veg Sandwich (Non Toast)", price: 50 },
    { name: "Chocolate Sandwich (Non Toast)", price: 70 },
    { name: "Veg Cheese Sandwich (Non Toast)", price: 80 },
    { name: "Plain Cheese Sandwich (Non Toast)", price: 80 },
    { name: "Chocolate Cheese Sandwich (Non Toast)", price: 100 },
  ],
  "Grilled Sandwich": [
    { name: "Veg Grilled Sandwich", price: 80 },
    { name: "Veg Schezwan Grilled Sandwich", price: 90 },
    { name: "Chocolate Grilled Sandwich", price: 90 },
    { name: "Veg Cheese Grilled Sandwich", price: 110 },
    { name: "Plain Cheese Grilled Sandwich", price: 110 },
    { name: "Veg Schezwan Cheese Grilled Sandwich", price: 120 },
    { name: "Chocolate Cheese Grilled Sandwich", price: 120 },
    { name: "Veg Paneer Cheese Grilled Sandwich", price: 140 },
    { name: "Veg Pizza Cheese Grilled Sandwich", price: 140 },
  ],
  "French Fries": [
    { name: "Salted Fries", price: 90 },
    { name: "Masala Fries", price: 100 },
    { name: "Peri Peri Fries", price: 100 },
    { name: "Cheese Fries", price: 130 },
    { name: "Peri Peri Cheese Fries", price: 100 },
  ],
  "Chaat": [
    { name: "Pani Puri", price: 30 },
    { name: "Sev Puri", price: 40 },
    { name: "Masala Puri", price: 40 },
    { name: "Ragda Kachori", price: 40 },
    { name: "Oli Bhel", price: 50 },
    { name: "Sukhi Bhel", price: 50 },
    { name: "Oli Cheese Bhel", price: 80 },

  ],
  "Milkshake": [
    { name: "Cold Coffee", variants: [{name: "Half", price:60},{ name: "Regular", price: 90 }, { name: "With Ice Cream", price: 110 }] },
    { name: "Mango Shake", variants: [{name: "Half", price:60},{ name: "Regular", price: 90 }, { name: "With Ice Cream", price: 110 }] },
    { name: "Strawberry Shake", variants: [{name: "Half", price:60},{ name: "Regular", price: 90 }, { name: "With Ice Cream", price: 110 }] },
    { name: "Chocolate Shake", variants: [{name: "Half", price:60},{ name: "Regular", price: 90 }, { name: "With Ice Cream", price: 110 }] },
    { name: "Oreo Shake", variants: [{name: "Half", price:60},{ name: "Regular", price: 90 }, { name: "With Ice Cream", price: 110 }] },
    { name: "Butterscotch Shake", variants: [{name: "Half", price:60},{ name: "Regular", price: 90 }, { name: "With Ice Cream", price: 110 }] },
  ],
  "Bread Pizza": [
